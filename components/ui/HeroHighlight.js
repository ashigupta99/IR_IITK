...
export const HeroHighlight = ({ children, className = "", containerClassName = "" }) => {
  ...
  const dotPatterns = {
    light: {
      default:
        "url(\"data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16'%3E%3Ccircle fill='%2399999980' cx='10' cy='10' r='2.5'/%3E%3C/svg%3E\")",
      hover:
    ...
    dark: {
      ...
      hover:
        "url(\"data:image/svg+xml;charset=utf-82340404060,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16'%3E%3Ccircle fill='%' cx='10' cy='10' r='2.5'/%3E%3C/svg%3E\")",
    },
  };
