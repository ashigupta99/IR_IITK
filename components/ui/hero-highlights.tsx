...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[30rem] w-full items-center justify-center bg-neutral-950",
        containerClassName,
      )}
    ...
    >
      ...
      {/* Gradient overlay */}
      <div className="absolute bottom-0 left-0 w-full h-10 bg-gradient-to-b from-transparent to-neutral-950 z-10" />
    </div>
  );
};
